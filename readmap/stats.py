...
from readmap.btop_trace import Trace
from readmap.btop_trace import parse as parse_btop
from readmap.models import Contig, Junction, ReadClass, ReadGroup
...
def collect(
    ...
    The reads are needed again by :mod:`readmap.layout`, so they are collected
