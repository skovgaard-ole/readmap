...
from readmap.models import Annotation, ContigLayout
...
# `from readmap.render import theme` executes this file, and the interactive
...
def write_pdf(
    ...
    from readmap.render.frontpage import render_frontpage
    from readmap.render.mapfig import render_contig
    from readmap.render.plots import render_plots
    ...
    with PdfPages(path) as pdf:
        ...
        info["Creator"] = "readmap (Python port of read_print_23.pl)"
