"""readmap -- visualise long sequence reads mapped onto a reference by BLAST.
...
def main(argv: list[str] | None = None) -> int:
    ...
    from readmap.cli import SUBCOMMANDS, parse_args, parse_browse_args

    raw = list(sys.argv[1:] if argv is None else argv)

    if raw and raw[0] in SUBCOMMANDS:
        from readmap.pipeline import browse
