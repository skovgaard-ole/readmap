...
:class:`~readrift.browser.store.BrowserStore`.
...
from readrift.browser.region import DEFAULT_LIMIT, build_region
from readrift.browser.store import CLASS_NAMES, EVENT_KINDS, JUNCTION_NAMES, BrowserStore
...
class _Handler(BaseHTTPRequestHandler):
    ...
    def _serve_static(self, route: str) -> None:
        ...
        try:
            ...
            return self._error(
                ...
                f"missing front-end file {filename}; reinstall readrift",
            )
        ...
        self._json(
            {
                ...
                "readrift_version": meta.get("readrift_version", ""),
    ...
    def _api_export(self, query: dict) -> None:
        ...
        from readrift.browser.export import render_region

        sample = str(self.store.meta.get("sample", "readrift"))
...
def serve(
    ...
    if not _STATIC_DIR.is_dir():
        print(
            ...
            f"       Reinstall readrift, or run from a checkout that has them.\n"
        )
        return 1
    ...
    print(f"\n  readrift browser  --  {store.meta.get('sample', '')}")
